...
The *KLayout Productivity Suite* *documentation* source code is made publicly available on GitHub ([follow this link](https://github.com/iic-jku/klayout-productivity-suite)) and shared under the Apache-2.0 license.
...
- `KLayoutProductivitySuite` acts as a meta-package that can be installed in KLayout's Package Manager. Once installed, it automatically pulls in all the plugins as `dependencies` through the `grain.xml`
